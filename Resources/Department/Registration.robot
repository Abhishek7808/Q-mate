...
Member List By Department
    Input Valid Value    SSO ID    ${SSOID["SSOID"]}
    Input Valid Value    Your Name    ${SSOID["Name"]}
    Input Valid Value    Your Designation    ${SSOID["Designation"]}
    Input Valid Value    Mobile Number    ${SSOID["Mobile Number"]}
    Input Valid Value    Alternate Mobile Number    ${SSOID["Alternate Mobile Number"]}
    Input Valid Value    Email ID    ${SSOID["Email ID"]}
    Input Valid Value    Fax    ${SSOID["Fax"]}
...
Fill FI By Department
    Input Valid Value    Financial Instrument Enter Customer PAN or Name    ${Value}
    Input Valid Value    Financial Instrument Purchasing for Self Use    ${Branch["User Type"]}
    Input Valid Value    Financial Instrument Branch Name    ${Branch["Name"]}
    Input Valid Value    Financial Instrument Pincode    ${Branch["Pincode"]}
    Input Valid Value    Financial Instrument State    ${Branch["State"]}
    Input Valid Value    Financial Instrument City    ${Branch["City"]}
    Input Valid Value    Financial Instrument Address Line 1    ${Branch["Address Line 1"]}
    Input Valid Value    Financial Instrument Address Line 2    ${Branch["Address Line 2"]}
