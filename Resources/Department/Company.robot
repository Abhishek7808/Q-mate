...
Schedule On
    Input Valid Value    Select Component*    ${SPACE}${testData["Schedule On"]["Select Component*"]}
    Input Valid Value    Start From    ${testData["Schedule On"]["Start From"]}
    Input Valid Value    End    ${testData["Schedule On"]["End"]}
    Input Valid Value    Application From    ${testData["Schedule On"]["Application From"]}
...
Formula
    Input Valid Value    Calculation Type    ${testData["Formula"]["Calculation Type"]}
    Input Valid Value    Priority    ${testData["Formula"]["Priority"]}
    Input Valid Value    Formula    ${testData["Formula"]["Formula"]}
