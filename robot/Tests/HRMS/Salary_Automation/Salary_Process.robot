...
*** Variables ***
${TEST_PAYGROUP}  None
${SALARYFINANCIALYEAR}  20222023           #20172018
${SALARYCYCLE}  None          #58
...
Create Salary Cycle
    ...
    HRMS_Keywords.Verify Salary Cycle

Review Attendance Of Employees
    [Documentation]  Fills details in Review Attendance form and submits it.
    [Tags]  HRMS  Salary  reviewAttendance  createdata
    Common_Keywords.Set Test Data  ${configData["Review_Attendance"]}
    HRMS_Keywords.Open Review Attendance Page
    HRMS_Keywords.Set Review Attendance Criteria  ${dataDictionary}       ###""" This will not select paygroup."""###
    HRMS_Keywords.Submit Reviewed Attendance
    HRMS_Keywords.Apply Filters For Reviewed Attendance
    HRMS_Keywords.Verify Reviewed Mark Attendance
...
Process And Lock Salary
    ...
    HRMS_Keywords.Open Salary Detail Page
    HRMS_Keywords.Check Request Status
...
Add Paybill
    ...
    Log Many   ${dataDictionary["Pay Group"]["Value"]}
